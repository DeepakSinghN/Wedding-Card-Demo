...
export default function Collage() {
  ...
  useGSAP(
    () => {
      ...
      tl.to(".cell-top-left", { opacity: 1, y: 0, duration: 0.6, ease: "power3.out" }, 0.0)
        .to(".cell-top-right", { opacity: 1, y: 0, duration: 0.6, ease: "power3.out" }, 0.08)
        .to(".cell-text-1", { opacity: 1, y: 0, letterSpacing: "0.05em", duration: 0.8, ease: "power2.out" }, 0.22)
        ...
        .to(".cell-bottom-left", { opacity: 1, y: 0, duration: 0.6, ease: "power3.out" }, 0.66)
        .to(".cell-text-2", { opacity: 1, y: 0, letterSpacing: "0.05em", duration: 0.8, ease: "power2.out" }, 0.80)
        .to(".cell-bottom-right", { opacity: 1, y: 0, duration: 0.6, ease: "power3.out" }, 0.94);
    ...
    >
      ...
      >
        ...
        <div 
          ...
          style={{ left: "5.51%", top: "30.47%", width: "51.38%", height: "8.79%" }}
        >
          <p 
            className="font-serif italic text-[#9D2C2D] text-[3.8cqi] leading-[1.3] font-medium"
        ...
        <div 
          ...
          style={{ left: "43.25%", top: "63.67%", width: "51.38%", height: "8.30%" }}
        >
          <p 
